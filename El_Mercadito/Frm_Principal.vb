Public Class Frm_Principal
    Private Sub Frm_Principal_Load(sender As Object, e As EventArgs) Handles
MyBase.Load()
        ...
        Me.Text = SISTEMA
        Me.Stb_Barra_Estado.Items(0).Text = Space(0) & "USUARIO: " &
       LOGIN_USER & Space(15) & "NOMBRE DEL USUARIO: " & NOMBRE_USER & Space(15) &
       "TIPO DE CUENTA: " & TIPO_USER
